...
row.addEventListener("click", function (event) {
    if (event.target.classList.contains("editable")) {
        ...
        input.value = (value === "Click to edit") ? "" : value;
        ...
        function save() {
            ...
            newh2.textContent = input.value || "Enter the value";
...
function addrow() {
    ...
    for (let i = 0; i < 3; i++) {
        ...
        // Restore "Enter the value" for description and others
        if (column[i] === "column2") {
            div.innerHTML = `<h2 class="editable" style="color:var(--color-credit);">"Click to edit"</h2>`;
        } else if (column[i] === "column3") {
            div.innerHTML = `<h2 class="editable" style="color:var(--color-debit);">'0'</h2>`;
        } else {
            div.innerHTML = `<h2 class="editable">'0'</h2>`;
        }
        row.appendChild(div);
    }
}
